...
const UploadLibrary: React.FC = () => {
  ...
  const handleUpload = (e: FormEvent) => {
    e.preventDefault();
    window.alert("🚫 Upload unavailable in demo mode.");
  };

  const handleDelete = () => {
    if (selectedKeys.size === 0) return;
    window.alert("🚫 Delete unavailable in demo mode.");
  };
  ...
  return (
    <div className="flex flex-col items-center min-h-screen bg-gradient-to-r from-white to-blue-100 p-8">
      <div className="bg-white shadow-xl rounded-2xl p-8 w-full max-w-4xl">
        <h1 className="text-2xl font-bold mb-6 text-center text-blue-700">Upload Library (Demo Mode)</h1>
